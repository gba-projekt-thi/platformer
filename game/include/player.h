...
class Player : public PhysicsBody {
   ...
   private:
    ...
    static constexpr bn::fixed ACCELERATION = Cfg::Player::ACCELERATION;

    static constexpr bn::fixed MAX_SPEED = Cfg::Player::MAX_SPEED;

    static constexpr bn::fixed JUMP_SPEED = Cfg::Player::JUMP_SPEED;

    static constexpr bn::fixed GRAVITY = Cfg::Player::GRAVITY;

    static constexpr bn::fixed MAX_FALL_SPEED = Cfg::Player::MAX_FALL_SPEED;

    static constexpr int DEATH_HEIGHT = Cfg::Player::DEATH_HEIGHT;
