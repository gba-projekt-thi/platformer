...
constexpr TrapData level2_traps[] = {
    {TrapType::BASE, -112, -16, 16, 16, 0, 0, bn::sprite_items::pipe16x16, 26,
     TRAP_GRAPHICS_INDEXES_0, -1, 0, 0, 0, NO_PATH_TRAP, 0},

    {TrapType::MOVING, -48, 88, 32, 32, 0, 0, bn::sprite_items::can32x32, 26,
     TRAP_GRAPHICS_INDEXES_3, 0, 0.0, -3, 3, NO_PATH_TRAP, 0},

    {TrapType::BASE, 0, 40, 32, 16, 0, 0, bn::sprite_items::rustynails32x16, 26,
     TRAP_GRAPHICS_INDEXES_3, -1, 0, 0, 0, NO_PATH_TRAP, 0},

    {TrapType::BASE, 80, 24, 16, 16, 0, 0, bn::sprite_items::pipe16x16, 26,
     TRAP_GRAPHICS_INDEXES_0, -1, 0, 0, 0, NO_PATH_TRAP, 0}};
