...
void StartScene::_refresh_slot_text() {
    if (!_text_gen.has_value()) {
        return;
    }
...
void StartScene::_handle_selection_change() {
...
void StartScene::_handle_start_input() {
...
void StartScene::_start_selected_save() {
