...
PYTHON      	:=  python
SOURCES     	:=  game/src game/src/traps extern/engine/core/src extern/engine/extern/butano/common/src
INCLUDES    	:=  game/include extern/engine/core/include extern/engine/extern/butano/common/include
DATA        	:=
